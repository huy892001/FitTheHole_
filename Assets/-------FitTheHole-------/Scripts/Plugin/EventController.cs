...
public class EventController : MonoBehaviour
{
  ...
  new System.Collections.Generic.Dictionary<string, object>();
    ...
    void FetchComplete(Task fetchTask)
    {
        ...
        //DataParam.warningInternetRunTime = Firebase.RemoteConfig.FirebaseRemoteConfig.GetInstance(app).GetValue(remoteDefault[1].key).StringValue == "0" ? false : true;
        ...
        //DataParam.on_hint_button = Firebase.RemoteConfig.FirebaseRemoteConfig.GetInstance(app).GetValue(remoteDefault[3].key).StringValue == "0" ? false : true;
        //Debug.LogError("======= on_app_open " +Firebase.RemoteConfig.FirebaseRemoteConfig.GetInstance(app).GetValue(remoteDefault[2].key).StringValue  + "    showopenads: " + DataParam.ShowOpenAds);
        //Debug.LogError("========= hint btn:" + DataParam.on_hint_button);
    }
...
#region Adjust
    public static void SHOW_INTER_ADJUST()
    {
        AdjustEvent adjustEvent = new AdjustEvent("h5l6r6");
        Adjust.trackEvent(adjustEvent);
    }
    public static void SHOW_VIDEO_ADJUST()
    {
        AdjustEvent adjustEvent = new AdjustEvent("rnamli");
        Adjust.trackEvent(adjustEvent);
    }
    public static void SHOW_APP_OPEN_ADJUST()
    {
        AdjustEvent adjustEvent = new AdjustEvent("v0res6");
        Adjust.trackEvent(adjustEvent);
    }
    public static void PLAY_LEVEL_ADJUST()
    {
        AdjustEvent adjustEvent = new AdjustEvent("w8wj4a");
        Adjust.trackEvent(adjustEvent);
    }
    #endregion
...
System.Collections.Generic.Dictionary<string, string>();
    ...
    public static void AF_LEVEL_ACHIEVED()// hieenr thij luc wwin
    {
        System.Collections.Generic.Dictionary<string, string> paramEvent = new
System.Collections.Generic.Dictionary<string, string>();
